...
(let ((class '((class color) (min-colors 89)))
  ...
  (nord1 (if (or (daemonp) (display-graphic-p)) "#3B4252" "black"))
  (nord2 (if (or (daemonp) (display-graphic-p)) "#434C5E" "#434C5E"))
  (nord3 (if (or (daemonp) (display-graphic-p)) "#4C566A" "brightblack"))
  (nord4 (if (or (daemonp) (display-graphic-p)) "#D8DEE9" "#D8DEE9"))
  (nord5 (if (or (daemonp) (display-graphic-p)) "#E5E9F0" "white"))
  (nord6 (if (or (daemonp) (display-graphic-p)) "#ECEFF4" "brightwhite"))
  (nord7 (if (or (daemonp) (display-graphic-p)) "#8FBCBB" "cyan"))
  (nord8 (if (or (daemonp) (display-graphic-p)) "#88C0D0" "brightcyan"))
  (nord9 (if (or (daemonp) (display-graphic-p)) "#81A1C1" "blue"))
  (nord10 (if (or (daemonp) (display-graphic-p)) "#5E81AC" "brightblue"))
  (nord11 (if (or (daemonp) (display-graphic-p)) "#BF616A" "red"))
  (nord12 (if (or (daemonp) (display-graphic-p)) "#D08770" "brightyellow"))
  (nord13 (if (or (daemonp) (display-graphic-p)) "#EBCB8B" "yellow"))
  (nord14 (if (or (daemonp) (display-graphic-p)) "#A3BE8C" "green"))
  (nord15 (if (or (daemonp) (display-graphic-p)) "#B48EAD" "magenta"))
  (nord-annotation (if (or (daemonp) (display-graphic-p)) "#D08770" "brightyellow"))
  (nord-attribute (if (or (daemonp) (display-graphic-p)) "#8FBCBB" "cyan"))
  (nord-class (if (or (daemonp) (display-graphic-p)) "#8FBCBB" "cyan"))
  (nord-comment (if (or (daemonp) (display-graphic-p)) (nord-theme--brightened-comment-color nord-comment-brightness) "brightblack"))
  (nord-escape (if (or (daemonp) (display-graphic-p)) "#D08770" "brightyellow"))
  (nord-method (if (or (daemonp) (display-graphic-p)) "#88C0D0" "brightcyan"))
  (nord-keyword (if (or (daemonp) (display-graphic-p)) "#81A1C1" "blue"))
  (nord-numeric (if (or (daemonp) (display-graphic-p)) "#B48EAD" "magenta"))
  (nord-operator (if (or (daemonp) (display-graphic-p)) "#81A1C1" "blue"))
  (nord-preprocessor (if (or (daemonp) (display-graphic-p)) "#5E81AC" "brightblue"))
  (nord-punctuation (if (or (daemonp) (display-graphic-p)) "#D8DEE9" "#D8DEE9"))
  (nord-regexp (if (or (daemonp) (display-graphic-p)) "#EBCB8B" "yellow"))
  (nord-string (if (or (daemonp) (display-graphic-p)) "#A3BE8C" "green"))
  (nord-tag (if (or (daemonp) (display-graphic-p)) "#81A1C1" "blue"))
  (nord-variable (if (or (daemonp) (display-graphic-p)) "#D8DEE9" "#D8DEE9"))
